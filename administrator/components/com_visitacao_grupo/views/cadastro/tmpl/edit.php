...
$document->addStyleSheet(Uri::root() . 'media/com_visitacao_grupo/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_visitacao_grupo&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'sub', JText::_('COM_VISITACAO_GRUPO_TAB_SUB', true)); ?>
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_VISITACAO_GRUPO_FIELDSET_SUB'); ?></legend>
				<?php echo $this->form->renderField('nome'); ?>
				<?php echo $this->form->renderField('telefone'); ?>
				<?php echo $this->form->renderField('email'); ?>
				<?php echo $this->form->renderField('idadecriancas'); ?>
				<?php echo $this->form->renderField('numerocriancas'); ?>
				<?php echo $this->form->renderField('adultos'); ?>
