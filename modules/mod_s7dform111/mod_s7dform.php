...
$doc->addStyleSheet(JUri::base(true).'/modules/mod_s7dform/assets/css/style.css?'.$scriptVersion);
...
$doc->addScript(JUri::base(true).'/modules/mod_s7dform/assets/js/scripts.js?v='.$scriptVersion);
$doc->addScript(JUri::base(true).'/modules/mod_s7dform/assets/js/gerarMulti.js?v='.$scriptVersion);
$doc->addScript(JUri::base(true).'/modules/mod_s7dform/assets/js/editarUsuario.js?v=9');
