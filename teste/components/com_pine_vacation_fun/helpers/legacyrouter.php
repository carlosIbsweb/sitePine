 ...
 * @since  1.6
 */
class Pine_vacation_funRulesLegacy implements RulesInterface
{
    /**
    ...
    public function parse(&$segments, &$vars)
    {
        ...
        $model        = Pine_vacation_funHelpersPine_vacation_fun::getModel($vars['view']);
