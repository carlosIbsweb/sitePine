				...
				<?php foreach(paymentsCart::getItens() as $items): ?>
					<?php if($cat->id == $items->catid): ?>
						<div class="dStoreItems">
							...
							<span class="dSprice"><span class="lPriceIn"><?= $textoPayment;?>: </span><span class="dSpriceM"><?php if($finalPrice  != ''): ?>R$ </span><?= number_format( $finalPrice , 2, ',', '.'); ?><?php endif; ?></span>

							<?php if(!empty($cparam->diarias)):?>
							<span class="dSprice diariaPine"><span class="lPriceIn diariaP">Diária: </span><span class="dSpriceM"><?php if($finalPrice  != ''): ?>R$ </span><?= number_format( $priceDia , 2, ',', '.'); ?><?php endif; ?></span>
							<?php endif;?>
