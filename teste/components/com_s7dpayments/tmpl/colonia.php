...
<div class="coloniaPine">
<div class="coloniaPage">
	<h1><?= $active->title;?></h1>
	<div class="coloniaPageItems container">
		<?php foreach(paymentsCart::getCat() as $k=> $item): ?>
			<div class="coloniaPageItemcContent">
				<a href="<?= $itemAlias.'/'.$item->alias;?>" class="<?= $item-> alias; ?>" style="background: url(https://pinetreefarm.com.br/teste/images/colonia/2021/julho/12a16/manha_4a13anos.jpg)" title="<?= $items->title;?>">
...
<div class="dist">
	<?php 
		...
		echo JHtml::_('content.prepare', '{loadposition colonia-bottom}');
...
let ptitle = document.querySelector('.coloniaPine h1')
	ptitle.innerText = sepMes(ptitle.innerText,false)
