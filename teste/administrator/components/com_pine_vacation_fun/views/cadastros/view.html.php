...
/**
 * View class for a list of Pine_vacation_fun.
 *
 * @since  1.6
 */
class Pine_vacation_funViewCadastros extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Pine_vacation_funHelper::addSubmenu('cadastros');
	...
	protected function addToolbar()
	{
		...
		$canDo = Pine_vacation_funHelper::getActions();

		JToolBarHelper::title(Text::_('COM_PINE_VACATION_FUN_TITLE_CADASTROS'), 'cadastros.png');
		...
		{
			JToolBarHelper::preferences('com_pine_vacation_fun');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_pine_vacation_fun&view=cadastros');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`nome_resp`' => JText::_('COM_PINE_VACATION_FUN_CADASTROS_NOME_RESP'),
			'a.`telefone`' => JText::_('COM_PINE_VACATION_FUN_CADASTROS_TELEFONE'),
			'a.`email`' => JText::_('COM_PINE_VACATION_FUN_CADASTROS_EMAIL'),
			'a.`visita`' => JText::_('COM_PINE_VACATION_FUN_CADASTROS_VISITA'),
			'a.`date`' => JText::_('COM_PINE_VACATION_FUN_CADASTROS_DATE'),
		);
	}
