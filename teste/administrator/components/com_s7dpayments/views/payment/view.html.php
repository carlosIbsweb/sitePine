 ...
 * @since  1.6
 */
class S7dpaymentsViewPayment extends JViewLegacy
{
    protected $state;
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title('S7D Payments: '.JText::_('COM_S7DPAYMENTS_PAGE_'.($checkedOut ? 'VIEW_PAYMENT' : ($isNew ? 'ADD_PAYMENT' : 'EDIT_PAYMENT'))), 'article-add.png');
