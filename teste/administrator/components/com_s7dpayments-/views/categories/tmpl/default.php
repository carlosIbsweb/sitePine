...
if ($saveOrder)
{
    $saveOrderingUrl = 'index.php?option=com_s7dpayments&task=categories.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_s7dpayments&view=categories'); ?>" method="post"
    ...
    <?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.`state`', $listDirn, $listOrder); ?>
                    ...
                    <?php endif; ?>
                                    ...
                                    <th class='left'>
                <?php echo JHtml::_('grid.sort',  'COM_S7DPAYMENTS_CATEGORIES_TITLE', 'a.`title`', $listDirn, $listOrder); ?>
                </th>
                <th class='left'>
                <?php echo JHtml::_('grid.sort',  'COM_S7DPAYMENTS_CATEGORIES_CREATED_BY', 'a.`created_by`', $listDirn, $listOrder); ?>
                </th>
                <th class='left'>
                <?php echo JHtml::_('grid.sort',  'COM_S7DPAYMENTS_CATEGORIES_DATE', 'a.`date`', $listDirn, $listOrder); ?>
                </th>
    ...
    <?php echo JHtml::_('jgrid.published', $item->state, $i, 'categories.', $canChange, 'cb'); ?>
                ...
                <?php endif; ?>
                <?php if ($canEdit) : ?>
                    <a href="<?php echo JRoute::_('index.php?option=com_s7dpayments&task=category.edit&id='.(int) $item->id); ?>">
