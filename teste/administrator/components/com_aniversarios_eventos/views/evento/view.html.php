 ...
 * @since  1.6
 */
class Aniversarios_eventosViewEvento extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ANIVERSARIOS_EVENTOS_TITLE_EVENTO'), 'evento.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_aniversarios_eventos.evento', $this->item->id);
		}
