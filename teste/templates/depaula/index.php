...
//Depauala códigos
$doc->addStyleSheet(JUri::base(true).'templates/depaula/css/dhovers.css');
$doc->addStyleSheet(JUri::base(true).'templates/depaula/css/dhovers2.css');
$doc->addStyleSheet('http://fonts.googleapis.com/css?family=Raleway:400,800,300');
$doc->addScript(JUri::base(true).'templates/depaula/js/jquery.mask.min.js');
$doc->addScript(JUri::base(true).'templates/depaula/js/dpmask.min.js');
