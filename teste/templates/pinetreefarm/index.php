...
/*******
 *Forçando HTTP para HTTPS
 ******/
/*$htt = explode("://",JUri::current());

if($htt[0] == 'http'){
    header('Location: https://'.$htt[1]);
}*/
    ...
    <head>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                //$this->helix3->addLess('presets', 'preset/' . $this->helix3->Preset(), array('class' => 'preset'));

                $doc->addStyleSheet(JUri::base(true).'/templates/'.$this->template.'/css/presets/'.$this->helix3->Preset().'.css?'.uniqid(), 'text/css', null, array('id' => 'custom'));
