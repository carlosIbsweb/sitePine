...
jQuery(function($) {
    ...
    fbUtils.inArray = function(e, t) {
            ...
            if (n)
                for (var a = n.getElementsByTagName("field"), i = 0; i < a.length; i++) {
                    var o = fbUtils.parseAttrs(a[i]),
                        l = a[i].children || [];
                    l.length && (o.values = fbUtils.parseOptions(a[i])), r.push(o)
                }
            return r
            ...
            var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                ...
                sheight = e.heightt,
                c = e.values;
            e.name = n ? e.name + "-preview" : e.name, e.id = e.name, e.name = e.multiple ? e.name + "[]" : e.name, e.type = e.subtype || e.type, e.requiredwk && (e.requiredwk = null, e["aria-required"] = "true", s = '<span class="required">*</span>'), "hidden" !== e.type && (l && (l = '<span class="tooltip-element" tooltip="' + l + '">?</span>'), a = '<label for="' + e.id + '" class="fb-' + e.type + '-label">' + o + " " + s + " " + l + "</label>");
            var f = e.label;
            delete e.label, delete e.description, delete e.heightt;
            ...
            switch (e.type) {
                ...
                case "rich-text":
                    ...
                    var p = e.value || "";
                    r = a + "<textarea style='height:"+sheight+"'" + u + ">" + p + "</textarea>";
                ...
                case "radio-group":
                    ...
                    if (e.type = e.type.replace("-group", ""), "checkbox" === e.type && (e.name = e.name + "[]"), c) {
                        ...
                        if (e.other) {
                            ...
                            v = fbUtils.attrString(Object.assign({}, e, h)), i += "<input " + v + ' /> <label for="' + h.id + '">' + t.messages.other + '</label> <input type="text" 00000002101010000000000000000' + e.name + '" id="' + h.id + '-value" style="display:none;" />'
                        }
                    }
            ...
            if ("hidden" !== e.type) {
                var g = e.id ? "wk-" + e.type + " form-group field-" + e.id : "";
