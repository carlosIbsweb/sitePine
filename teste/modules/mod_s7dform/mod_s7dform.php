...
$doc->addStyleSheet(JUri::base(true).'/modules/mod_s7dform/assets/css/style.css?'.uniqid());
...
$doc->addScript(JUri::base(true).'/modules/mod_s7dform/assets/js/jquery.mask.min.js?1');
...
$doc->addScript(JUri::base(true).'/modules/mod_s7dform/assets/js/others.js?'.uniqid());
