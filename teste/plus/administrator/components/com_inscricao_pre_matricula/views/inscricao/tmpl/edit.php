...
$document->addStyleSheet(Uri::root() . 'media/com_inscricao_pre_matricula/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_inscricao_pre_matricula&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'sub', JText::_('COM_INSCRICAO_PRE_MATRICULA_TAB_SUB', true)); ?>
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_INSCRICAO_PRE_MATRICULA_FIELDSET_SUB'); ?></legend>
