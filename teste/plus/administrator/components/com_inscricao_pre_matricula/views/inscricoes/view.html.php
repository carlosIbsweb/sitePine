...
/**
 * View class for a list of Inscricao_pre_matricula.
 *
 * @since  1.6
 */
class Inscricao_pre_matriculaViewInscricoes extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Inscricao_pre_matriculaHelper::addSubmenu('inscricoes');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_INSCRICAO_PRE_MATRICULA_TITLE_INSCRICOES'), 'inscricoes.png');
		...
		{
			JToolBarHelper::preferences('com_inscricao_pre_matricula');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_inscricao_pre_matricula&view=inscricoes');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`nome`' => JText::_('COM_INSCRICAO_PRE_MATRICULA_INSCRICOES_NOME'),
			'a.`telefone`' => JText::_('COM_INSCRICAO_PRE_MATRICULA_INSCRICOES_TELEFONE'),
			'a.`email`' => JText::_('COM_INSCRICAO_PRE_MATRICULA_INSCRICOES_EMAIL'),
		);
	}
