 ...
 * @since  1.6
 */
class Inscricao_pre_matriculaRulesLegacy implements RulesInterface
{
    /**
    ...
    public function parse(&$segments, &$vars)
    {
        ...
        $model        = Inscricao_pre_matriculaHelpersInscricao_pre_matricula::getModel($vars['view']);
